...
import FuturePopulationCard from './FuturePopulationCard';
        ...
        <div className="p-6">
          ...
          {activeTab === 'demographics' && (
            <div id="demographics-panel" role="tabpanel" aria-labelledby="demographics-tab" className="space-y-6 animate-fade-in">
              {/* Future Population Data (if available) */}
              {(result?.futurePopulationData || dualResult?.futurePopulationData) && (
                <FuturePopulationCard data={(result?.futurePopulationData || dualResult?.futurePopulationData)!} />
              )}
